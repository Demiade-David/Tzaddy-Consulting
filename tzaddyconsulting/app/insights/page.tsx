...
const articleSections = [
  {
    ...
    text: "Every figure in your accounts is connected to a business decision. Revenue tells you what your business sold. Gross profit tells you what is left after the direct cost of making those sales. Operating expenses tell you what it costs to keep the business running. Receivables tell you how much of your reported sales you are still waiting to collect. Payables tell you how much of your obligations remain unpaid. Cash tells you what you can actually spend today. The real value comes from putting these numbers together. Because a single figure rarely tells the whole story.",
  },
  {
    title: "Revenue is growing. So why isn’t the business feeling better?",
    text: "Imagine a business whose revenue increased from ₦100 million to ₦150 million in a year. At first glance, that looks like excellent growth. But suppose its gross margin fell from 40% to 25%. The business has sold more, but it is keeping significantly less from every naira of sales. That changes the story completely. Growth is not automatically good growth. The right question is not simply: How much did we sell? It is: How much value did we retain from what we sold?",
  },
  {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
      <header className="mb-16">
        ...
        <div className="rounded-4xl border border-yellow-200 bg-linear-to-r from-yellow-100 via-yellow-50 to-amber-50 p-6 shadow-sm ring-1 ring-yellow-100 dark:border-yellow-900/60 dark:from-yellow-500/10 dark:via-yellow-500/5 dark:to-transparent dark:ring-yellow-800/50 md:p-8">
          <p className="text-xl leading-8 text-black dark:text-white">
            ...
            requirements. Business decisions. There is a lot to keep up with,
            and getting the technical answer is only half the job.
          </p>
        </div>
      </header>

      <section className="mb-16">
        <div className="rounded-4xl border border-gray-200 bg-white/90 p-6 shadow-sm transition-shadow duration-200 hover:shadow-md dark:border-gray-800 dark:bg-gray-950/80 md:p-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl bg-linear-to-br from-gray-900 to-gray-800 p-5 text-gray-100">
      ...
      <main className="space-y-8">
        <article className="rounded-4xl border border-amber-100 bg-linear-to-br from-amber-50 via-white to-yellow-50 p-4 shadow-sm dark:border-gray-800 dark:from-gray-900 dark:via-gray-950 dark:to-black md:p-8">
        ...
        <section className="rounded-4xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950 md:p-8">
          <h3 className="mb-4 text-2xl font-bold text-gray-900 dark:text-white">
            The Tzaddy Perspective
          </h3>
          <p className="text-lg leading-8 text-gray-700 dark:text-gray-300">
            At Tzaddy Consulting, we believe financial information should lead
            to better decisions. Your accounts should not sit in a folder until
            the next audit or tax filing. They should help you understand the
            health of your business, challenge your assumptions and make
            decisions with greater confidence. Because behind every number is a
            business reality. Behind revenue is a customer. Behind an expense is
            a decision. Behind a receivable is money you are waiting to collect.
        ...
        <a
          href="/contact"
          className="inline-block rounded-lg bg-blue-600 px-6 py-3 text-center font-semibold text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-500 dark:focus:ring-offset-2"
        >
          Get Started
        </a>
      </main>
